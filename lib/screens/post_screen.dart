...
class _PostScreenState extends State<PostScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return _file == null ? Center(child: IconButton(icon:const Icon(Icons.upload) ,
     ...
     Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(onPressed: ()=>postImage(user.uid,user.username,user.photoUrl), child: const Text('Post'))
        ],
